...
int main(){
    ...
    memset(t,-1,sizeof(t));
    int lengthOfLCS;
    lengthOfLCS = LongestCommonSubsequenceMemo(x,y,n,n);
    lengthOfLCS = LongestCommonSubsequenceRecursive(x,y,n,n);
    lengthOfLCS = LongestCommonSubsequenceDP(x,y,n,n);
    int ans = x.size() - lengthOfLCS;
    cout<<ans<<endl;
    return 0;
}